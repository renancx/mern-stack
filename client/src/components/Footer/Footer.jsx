        ...
        <footer className={styles["footer"]}>
            <div className={styles["footer-content"]}>
                <div className={styles["footer-content-center"]}>
                    <h2 className={styles["footer-content-center-title"]}>Address</h2>
                    <p className={styles["footer-content-center-description"]}>1234 Main Street</p>
                    <p className={styles["footer-content-center-description"]}>City, State, Country</p>
                </div>
